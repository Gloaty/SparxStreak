...
public class Program
{
	...
	public static class bookCodeHandler {
	    public static void bookCodeInitialise() {
            ...
            Console.WriteLine("Please Enter the Initial Letter of the BookCode. ");
            string bookCodeLetterInit = Console.ReadLine();
            int index = Array.IndexOf(alphabet, bookCodeLetterInit); //remove after testing
            Console.WriteLine(index); //remove after testing
            Console.Clear();
            Console.WriteLine("Please Enter the Initial Number of the Bookcode. ");
